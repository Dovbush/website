...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php bloginfo('template_url')?>/styles/vacancy-page.css">
    ...
    <body>
        ...
        <section id="vacancies-wrapper" class="single-vacancies"> 
                ...
                <div class="container no-padding">   
                    ...
                    <div class="col-xs-12">
                        <div class="vacancies-block">
                            <div class="date-wrapper single-vacancies"><?php echo get_the_date('l, F j, Y'); ?></div>
                                <h2 class="text-center single-vac-h"><?php the_title(); ?></h2>
                                <?php the_content(); ?>
                                <div class="words-wrapper">
                                    <?php the_tags('',''); ?>
                                </div>  
                                <hr>
                                <h3><?php echo $menuitem5 ?></h3>
                                <div class="recruiter-contacts">
                                    <div class="col-xs-12">
                                        <div class="col-xs-5 no-padding">
                                            <p class="recruiter-name">YULIYA SERENKO</p>
                                        </div>
                                        <div class="col-xs-7 no-padding">
                                            <ul>
                                                <li><?php echo $email ?> <a href="mailto:yuliya@4front.se">yuliya@4front.se</a></li>
                                                <li>Skype: <a href="skype:yserenko?chat">yserenko</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
