...
<html>
    <head>
        <title><?php echo $menuitem4 ?> | 4front</title>
    ...
    <body> 
        ...
        <div class="mobile-links-wrapper">
            <ul>
                ...
                <li><a class="scrolling" href="#vacancies-wrapper"><?php echo $menuitem4 ?></a></li>
            ...
            <div class="container no-padding vertical-align">
                ...
                <div class="col-xs-9 no-padding text-right">
                    <ul class="desktop-menu">
                        ...
                        <li><a class="scrolling active" href="#vacancies-wrapper"><?php echo $menuitem4 ?><hr></a></li>
        ...
        <section id="vacancies-wrapper"> 
            <div class="bg-pattern-light"></div>       
            <div class="container no-padding">
                <h1 class="text-center"><?php echo $menuitem4 ?></h1>    
            </div>  
            <div class="vacancies-container">
                <div class="container no-padding">    
                    ...
                    <div class="col-xs-12">
                        <div class="vacancies-block v-animate">
                    ...
                    $count = get_category('11')->category_count; 
                    ...
                    if ($count == 0) 
                        ...
                        echo  '<div class="col-xs-12">
                                    <div class="vacancies-block">
                                        ...
                                        <p>If you wish to be considered for any future positions, please send your CV and covering letter to :<br>
                                         <a href="mailto:yuliya@4front.se">yuliya@4front.se</a>
                                         </p></p>
                                        </p>
                        </div></div>';
        ...
        <script src="<?php bloginfo('template_url')?>/js/animate-css.js"></script>
