...
<html>
    <head>
        <title><?php echo $tags ?> | 4front</title>
    ...
    <body> 
        ...
        <section id="blog-wrapper" class="tags-wrapper"> 
            ...
            <div class="blog-inner">             
                ...
                <div class="news-container">
                    <div class="container news-inner no-padding tags-wrapper"> 
                      <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                            <div class="date-wrapper"><?php echo get_the_date('l, F j, Y'); ?></div>
                            <a class="tags-h" href="<?php echo get_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><h2><?php the_title(); ?></h2></a>
                        <?php endwhile; endif; ?>
                        <div class="words-wrapper">
                            <?php wp_tag_cloud('number=200'); ?>
                        </div>
                    </div>   
                </div>  
            </div>         
